    ...
    <div className="mt-[150px] pt-[15px] xl:pt-[30px] bg-[#F5F5F5] relative">
        <div className=' relative px-[50px] lg:px-[200px] w-[100%] -mt-[100px] z-10'>
          <div className=' bg-black p-[20px] lg:p-[35px] flex justify-between rounded-[20px]'>
            ...
            <div className='w-[40%] lg:w-[30%] flex flex-col justify-between'>
              <div className='flex items-center justify-between bg-white rounded-[20px] px-[10px]'>
                <EmailOutlined className='text-[#a9a7a7] w-[10%]'/>
                <input type="email" name="email" id="email" placeholder='Enter your email address' className='rounded-[20px] h-[40px] w-[85%] border-0 outline-none' />
              </div>
              <div className=' w-full'>
                <button className={`${openSans.className} bg-white rounded-[20px] w-full h-full font-normal p-[8px] hover:bg-[#f5f5f5] hover:text-[#737373]`}> Subscribe to Newsletter</button>
              </div>
        ...
        <div className=" md:flex justify-between px-[50px] lg:px-[100px] py-[40px]">
          <div className='w-[100%] py-[20px]'>
            <div className='flex flex-wrap md:flex justify-between w-full'>
              ...
              <div className=' w-[20%] md:w-[13%]'>
                ...
                <div className='flex flex-col text-[#737373] justify-between gap-3 py-[10px] '>
